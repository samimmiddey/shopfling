...
import { AiOutlineCalendar, AiOutlineShoppingCart, AiOutlineAreaChart, AiOutlineBarChart, AiOutlineStock, AiOutlineProfile } from 'react-icons/ai';
...
import { RiContactsLine, RiStockLine, RiChat2Line, RiMailLine } from 'react-icons/ri';
import { MdOutlineSupervisorAccount, MdOutlineAnalytics } from 'react-icons/md';
...
export const chatAppData = [
   {
      ...
      message: [
         {
            messageFor: ['Tom got a small piece of pie.']
         },
         {
            messageTo: ["I'd rather be a bird than a fish.", 'They got there early, and they got really good seats.']
         },
         {
            messageFor: ["If I don't like something, I'll stay away from it.", "I want more detailed information."]
         },
         {
            messageTo: ["We need to rent a room for our party."]
         }
      ]
   },
   {
      ...
      message: [
         {
            messageFor: ["The sky is clear", "How was the math test?"]
         },
         {
            messageTo: ["She always speaks to him in a loud voice."]
         },
         {
            messageFor: ["The memory we used to share is no longer coherent.", "The mysterious diary records the voice.", "The old apple revels in its authority."]
         },
         {
            messageTo: ["Please wait outside of the house."]
         }
      ]
   },
   {
      ...
      mails: [
         {
            ...
            subject: 'The Costanza Files',
            category: 'Promotional',
            time: '3:45 PM',
            message: 'Dummy text is text that is used in the publishing industry or by web designers to occupy the space which will later be filled with.'
         },
         {
            name: 'David James',
            email: 'david@gmail.com',
            subject: 'About The Gathering',
            category: 'Social',
            time: '5:12 PM',
            message: 'One disadvantage of Lorum Ipsum is that in Latin certain letters appear more frequently than others which creates a distinct visual impression.'
         },
         {
            name: 'Dexter Morgan',
            email: 'maria@gmail.com',
            subject: 'James Cooper Blood Spatter Analysis Report',
            category: 'Health',
            time: '10:23 AM',
            message: 'Thus, Lorem Ipsum has only limited suitability as a visual filler for German texts. If the fill text is intended to illustrate the characteristics of different typefaces.'
         },
         {
            name: 'Maria Laguerta',
            email: 'maria@gmail.com',
            subject: 'About The Trinity Case Files',
            category: 'Social',
            time: '8:36 PM',
            message: 'There is now an abundance of readable dummy texts. These are usually used when a text is required purely to fill a space.These alternatives to the classic Lorem Ipsum texts are often amusing and tell short, funny or nonsensical stories.'
         },
         {
            name: 'Elaine Benes',
            email: 'elaine@gmail.com',
            subject: 'Pendant Publishing Promotion',
            category: 'Promotional',
            time: '11:45 AM',
            message: 'Ultrices in iaculis nunc sed augue lacus viverra. Tellus cras adipiscing enim eu turpis egestas. Libero enim sed faucibus turpis in eu mi bibendum neque. Consectetur adipiscing elit ut aliquam. Mattis nunc sed blandit libero volutpat sed cras.'
         },
         {
            name: 'Cosmo Kramer',
            email: 'kramer@gmail.com',
            subject: 'Kelvin Klein Body Spray Proposal',
            category: 'Promotional',
            time: '9:14 AM',
            message: 'Ultrices in iaculis nunc sed augue lacus viverra. Tellus cras adipiscing enim eu turpis egestas. Libero enim sed faucibus turpis in eu mi bibendum neque. Consectetur adipiscing elit ut aliquam. Mattis nunc sed blandit libero volutpat sed cras.'
         }
      ...
      mails: [
         {
            ...
            subject: 'The Daily Mail Yearly Gathering',
            category: 'Promotional',
            time: '4:56 PM',
            message: 'Dummy text is also used to demonstrate the appearance of different typefaces and layouts, and in general the content of dummy text is nonsensical.'
         },
         {
            name: 'Jay Morrison',
            email: 'james@gmail.com',
            subject: 'About The Workout Routine Meeting',
            category: 'Health',
            time: '2:11 AM',
            message: 'This might also explain why one can now find slightly different versions. Due to the age of the Lorem Ipsum text there are no copyright issues to contend with.'
         },
         {
   ...
   },
   {
      ...
      mails: [
         ...
         },
         {
            ...
            subject: 'Meet Me Sharp at 4 PM',
            category: 'Social',
            time: '11:49 AM',
            message: 'The phrasal sequence of the Lorem Ipsum text is now so widespread and commonplace that many DTP programmes can generate dummy text using the starting sequence.'
         },
         {
            name: 'Lisandro Martinez',
            email: 'lisandro@gmail.com',
            subject: 'Team Meeting at Carrington',
            category: 'Health',
            time: '12:58 PM',
            message: 'The phrasal sequence of the Lorem Ipsum text is now so widespread and commonplace that many DTP programmes can generate dummy text using the starting sequence.'
         }
...
export const earningData = [
   {
      icon: <MdOutlineSupervisorAccount style={{ fontSize: '1.5rem' }} />,
      amount: '39,354',
      percentage: '-4%',
      title: 'Customers',
      iconColor: '#03C9D7',
   ...
   {
      icon: <BsBoxSeam style={{ fontSize: '1.5rem' }} />,
      amount: '4,396',
      percentage: '+23%',
      title: 'Products',
   ...
   {
      icon: <FiBarChart style={{ fontSize: '1.5rem' }} />,
      amount: '423,39',
      percentage: '+38%',
      title: 'Sales',
   ...
   {
      icon: <HiOutlineRefresh style={{ fontSize: '1.5rem' }} />,
      amount: '878',
      percentage: '-12%',
      title: 'Refunds',
...
export const modernData = [
   {
      icon: <FiShoppingBag style={{ fontSize: '1.5rem' }} />,
      amount: '39,354',
      percentage: '-4%',
      title: 'Monthly Sales',
      iconColor: 'white',
   ...
   {
      icon: <FiDollarSign style={{ fontSize: '1.5rem' }} />,
      amount: '$93,438',
      percentage: '+23%',
...
export const recentTransactions = [
   {
      icon: <BsCurrencyDollar style={{ fontSize: '1.5rem' }} />,
      amount: '+$350',
   ...
   {
      icon: <BsShield style={{ fontSize: '1.5rem' }} />,
      amount: '-$560',
      desc: 'Bill Payment',
      title: 'Wallet',
      iconColor: 'rgb(0, 194, 146)',
   ...
   {
      icon: <FiCreditCard style={{ fontSize: '1.5rem' }} />,
      amount: '+$350',
      title: 'Credit Card',
      desc: 'Money reversed',
      iconColor: 'rgb(254, 201, 15)',
   ...
   {
      icon: <TiTick style={{ fontSize: '1.5rem' }} />,
      amount: '+$350',
      title: 'Bank Transfer',
      desc: 'Money Added',
...
export const customersData = [
   {
      ...
      email: 'elaine@gmail.com',
      img: avatar2,
      occupation: 'Chief Excecutive Officer',
      status: 'Active',
      statusBg: '#8BE78B',
      weeks: '40',
      budget: '$2.4k'
...
export const ordersData = [
   ...
   {
      OrderID: 845954,
      CustomerName: 'Ray Patterson',
      TotalAmount: 59.99,
      OrderItems: 'BT Headphones',
      Location: 'USA',
      Status: 'complete',
      StatusBg: '#00cc99',
